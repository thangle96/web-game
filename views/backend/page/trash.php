            ...
            <table id = "myTable" class="table table-triped table-bordered table-hover">
                ...
                <?php foreach($list as $row) : ?>
                    <tr>
                        ...
                        href="index.php?option=page&cat=retrash&id=<?php echo $row['id']; ?>"><i class="fas fa-trash-restore"></i></a>
                        <a class="btn btn-sm btn-danger" 
                        href="index.php?option=page&cat=delete&id=<?php echo $row['id']; ?>"><i class="fas fa-trash"></i></a>
                        </td>
