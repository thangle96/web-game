...
foreach($listorder as $rowcat){
    if($row['id'] == $rowcat['id'])
    {
        $strcat .= "<option selected value='".$rowcat['id']."'>".$rowcat['code']."</option>";
    }else{
...
<form action="index.php?option=order&cat=process&id=<?php echo $row['id']; ?>" method="post" enctype="multipart/form-data">
            ...
            <div class="row">
                <div class="col-md-8">
                    <div class="form-group">
                        ...
                        <input name="code" type="text" class="form-control"  value="<?php echo $row['code'] ?>" placeholder="mã đơn hàng" required />
                    </div>
                    <div class="form-group">
                        <label style="font-weight: bold;">Tên khác hàng</label>
                        <input name="deliveryname" type="text"  value="<?php echo $row['deliveryname'] ?>" class="form-control" placeholder="tên đơn hàng" required />
                    </div>
                    <div class="form-group">
